...
from fairseq2_011.assets import (
    AssetCard,
...
from fairseq2_011.models.nllb.builder import NllbConfig, create_nllb_model, nllb_archs
from fairseq2_011.models.nllb.tokenizer import NllbTokenizer
from fairseq2_011.models.transformer import TransformerModel
from fairseq2_011.models.utils.checkpoint_loader import upgrade_fairseq_checkpoint
from fairseq2_011.models.utils.model_loader import ModelConfigLoader, ModelLoader
from fairseq2_011.typing import finaloverride
...
class NllbLoader(ModelLoader[TransformerModel, NllbConfig]):
    ...
    def _upgrade_checkpoint(
        ...
        # use a single embedding table in fairseq2_011.
