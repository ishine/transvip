...
from fairseq2_011.models.transformer import (
...
from .decoder import StandardTransformerDecoder
from .decoder_layer import StandardTransformerDecoderLayer
from .multihead_attention import StandardMultiheadAttention
from .custom_frontend import SpeakerEmbeddingFrontend
...
class NllbBuilder:
    ...
    def build_decoder_frontend(self, embed: Embedding, spk_embed_idx: int=2) -> SpeakerEmbeddingFrontend:
        ...
        return SpeakerEmbeddingFrontend(
            embed,
            pos_encoder,
            spk_embed_idx=spk_embed_idx,
            dropout_p=self.config.dropout_p,
            device=self.device,
            dtype=self.dtype,
        )
