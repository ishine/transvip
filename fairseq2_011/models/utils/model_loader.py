...
from fairseq2_011.models.utils.checkpoint_loader import load_checkpoint
from fairseq2_011.nn.utils.module import reset_non_persistent_buffers
from fairseq2_011.typing import DataType, Device
from fairseq2_011.utils.dataclass import update_dataclass
...
class ModelLoader(Generic[ModelT, ModelConfigT]):
    ...
    def _upgrade_checkpoint(
        ...
        """Upgrade ``checkpoint`` to be compatible with fairseq2_011.
        ...
        :returns:
            A checkpoint that is compatible with fairseq2_011.
        """
        return checkpoint
