...
from fairseq2_011.data.typing import StringLike
from fairseq2_011.typing import DataType
...
if TYPE_CHECKING or _DOC_MODE:
    ...
    from fairseq2_011n.bindings.data.text.converters import StrSplitter as StrSplitter
    from fairseq2_011n.bindings.data.text.converters import (
