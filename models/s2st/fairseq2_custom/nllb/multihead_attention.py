...
from fairseq2_011.nn.incremental_state import IncrementalState, IncrementalStateBag
from fairseq2_011.nn.position_encoder import PositionEncoder
from fairseq2_011.nn.projection import Linear, Projection
from fairseq2_011.nn.transformer.attention import SDPA, create_default_sdpa
from fairseq2_011.typing import DataType, Device, finaloverride, override
...
class StandardMultiheadAttention(MultiheadAttention):
    ...
    def forward(
        ...
        if attn_mask is not None and len(attn_mask.size()) == 4:
