...
class CheckpointConverter(Protocol):
    """Converts a checkpoint to make it compatible with fairseq2_011."""
    ...
    def __call__(self, checkpoint: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        :returns:
            A converted checkpoint that is compatible with fairseq2_011.
        """
...
def upgrade_fairseq_checkpoint(
    ...
    # Convert module keys from fairseq to fairseq2_011.
